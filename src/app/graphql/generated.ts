...
export type Article = {
  ...
  downloads: Array<Maybe<UploadFile>>;
  downloads_connection?: Maybe<UploadFileRelationResponseCollection>;
...
export type ArticleDownloadsArgs = {
...
export type ArticleDownloads_ConnectionArgs = {
  filters?: InputMaybe<UploadFileFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type GenericMorph = Article | Category | Contact | I18NLocale | ReviewWorkflowsWorkflow | ReviewWorkflowsWorkflowStage | UploadFile | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
